...
results_names=c(paste0("./Experiment_MNCAR_scenario2_results/MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",5,".RData"),
                paste0("./Experiment_MNCAR_scenario2_results/MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",10,".RData"),
                paste0("./Experiment_MNCAR_scenario2_results/MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",15,".RData"),
                paste0("./Experiment_MNCAR_scenario2_results/MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",20,".RData"),
                paste0("./Experiment_MNCAR_scenario2_results/MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",25,".RData"))

results_short_names=c(paste0("MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",5),
                      paste0("MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",10),
                      paste0("MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",15),
                      paste0("MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",20),
                      paste0("MNCARreplicate_",1:10,"_exp_n_500_p_9_nblocks_",25))
...
ggsave("MNCAR_errors.pdf",error_boxes,width=5,height=5)
...
ggsave("MNCAR_experiment_results_indRVs.pdf",resulting_plot)
...
resulting_plot=ggplot(data=tidy_varRVs,aes(x=block_num,y=varRV,group=method,color=method))+
  ylim(.45,1.2)+
  geom_smooth(method="loess")
ggsave("MNCAR_experiment_results_varRVs.pdf",resulting_plot)
