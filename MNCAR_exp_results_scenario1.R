...
results_names=c(paste0("./Experiment_MNCAR_scenario1_results/MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",5,".RData"),
                paste0("./Experiment_MNCAR_scenario1_results/MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",10,".RData"),
                paste0("./Experiment_MNCAR_scenario1_results/MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",15,".RData"),
                paste0("./Experiment_MNCAR_scenario1_results/MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",20,".RData"),
                paste0("./Experiment_MNCAR_scenario1_results/MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",25,".RData"))

results_short_names=c(paste0("MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",5),
                      paste0("MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",10),
                      paste0("MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",15),
                      paste0("MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",20),
                      paste0("MNCAR_bad_start_replicate_",1:10,"_exp_n_500_p_9_nblocks_",25))
...
ggsave("MNCAR_bs_errors.pdf",error_boxes,width=5,height=5)
...
tidy_indRVs=indRVs_tbl%>%
  separate(scenario,into=c("replicate","blocks"),sep="_exp_")%>%
  separate(replicate,into=c("replicate","replicate_num"),sep="_",convert=TRUE)%>%
  separate(blocks,into=c("block_size","block_num"),sep="_nblocks_",convert=TRUE)%>%
...
ggsave("MNCAR_bad_start_experiment_results_indRVs.pdf",resulting_plot)
...
resulting_plot=ggplot(data=tidy_varRVs,aes(x=block_num,y=varRV,group=method,color=method))+
  ylim(.45,1.2)+
  geom_smooth(method="loess")
ggsave("MNCAR_bad_start_experiment_results_varRVs.pdf",resulting_plot)
